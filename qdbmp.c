...
typedef struct _BMP_Header
{
	...
	UINT   ColorsUsed;			/* Number of color indexes in the color table used by the BMP */
	UINT   ColorsRequired;		/* Number of color indexes required for displaying the BMP */
} BMP_Header;
...
int	ReadUINT( UINT * x, FILE * f )
{
	UCHAR little[ 4 ] = {0};	/* BMPs use 32 bit ints */
